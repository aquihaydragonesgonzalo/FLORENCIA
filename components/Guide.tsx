...
const Guide: React.FC<GuideProps> = ({ userLocation }) => {
  ...
  useEffect(() => {
    const fetchWeather = async () => {
      try {
        // Coordenadas actualizadas para Florencia (aprox 43.77, 11.25)
  ...
  // Datos del resumen de la visita actualizados para Florencia
  const visitSummary = {
    totalWindow: "12h 30min", // De 07:00 a 19:30
    sightseeingTime: "4h 10min", // Tiempo neto en Florencia (aprox)
    logisticsTime: "5h 20min", // Trenes y traslados Livorno-Florencia
    ...
    <div className="pb-32 px-4 pt-6 max-w-lg mx-auto h-full overflow-y-auto no-scrollbar">
      ...
      <div className="mb-8">
        <h3 className="text-sm font-black text-slate-800 mb-4 flex items-center uppercase tracking-widest px-1">
          <Thermometer size={18} className="mr-2 text-blue-900"/> Tiempo en Florencia
        </h3>
